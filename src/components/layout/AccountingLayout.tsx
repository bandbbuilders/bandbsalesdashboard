...
export const AccountingLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Journal", href: "/accounting/journal", icon: BookOpen },
    { name: "T-Accounts", href: "/accounting/taccounts", icon: FileText },
    { name: "P&L", href: "/accounting/pnl", icon: TrendingUp },
    { name: "Balance Sheet", href: "/accounting/balance", icon: DollarSign },
    { name: "Cash Flow", href: "/accounting/cashflow", icon: Activity },
  ];
